...
export default ({ handlePlayAgain, handleNext, handleClick, handleSubmit, findNotes, handleLevel, notes, fingerings, index, message, location, score, randomIndex, high }) => (
    <Switch>
        ...
        <Route path='/levels' render={() => <Levels handleLevel={handleLevel} findNotes={findNotes} high={high} />} />
